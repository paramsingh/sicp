...
(define (delete-queue! q)
  (cond ((empty-queue? q) (error "cannot delete from empty queue"))
        (else
         (begin
           (set-front-ptr! q (cdr (front-ptr q)))
           (if (null? (front-ptr q)) (set-rear-ptr! q nil)))
         q)))
...
;;; Define a procedure print-queue that takes a queue as input
